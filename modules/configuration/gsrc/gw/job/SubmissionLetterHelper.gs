...
class SubmissionLetterHelper {
  static function getCheckedSubmissions(): Submission[] {
    ...
    var submissionsIter = PCFElementFindUtil.findDescendent(PLDependencies.getNavigator().getTopLocation(), criteria) as IteratorWidget
  ...
  static function getDocumentsByPolicyPeriodAndDocType(submissions: Submission[]): java.util.Map<String, Document> {
    ...
    var criteria = new DocumentSearchCriteria(new EntityBundleImpl())
