...
@Export
@gw.lang.Deprecated(:value="800 inter-app integration packages will be removed in PC10.", :version="PC 9.0.0")
class GWClaimSearchPlugin implements IClaimSearchPlugin {
  ...
  @Deprecated
  override function getClaimDetailByClaimNumber(claim: Claim): entity.ClaimDetail {
