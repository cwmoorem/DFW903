...
class BCBillingSystemPlugin implements IBillingSystemPlugin {
  ...
  @Deprecated("PC8.0. Use IBillingSystemPlugin#accountExists instead.")
  ...
  override function retrieveInstallmentsPlanPreview(policyPeriod : PolicyPeriod) : BillingPaymentsPreview {
    final var bcInvoiceItems = getInvoiceItems(policyPeriod, policyPeriod.SelectedPaymentPlan.BillingId, false)
    return convertToBillingPaymentsPreview(bcInvoiceItems, policyPeriod)
  }
  ...
  */
  ...
  @Deprecated("PC8.0. Use IBillingSystemPlugin#producerExists instead.")
  ...
  @Deprecated("PC8.0. Use updatePolicyPeriodTermConfirmed(String policyNumber, int termNumber, boolean isConfirmed) instead.")
  override function updatePolicyPeriodTermConfirmed(policyNumber : String, termNumber : int,
                                                    isConfirmed : Boolean) : void{
    BillingAPIWithLanguage.updatePolicyPeriodTermConfirmed(policyNumber, termNumber, isConfirmed)
  }
  ...
  private function getInvoicesOtherPolicies(policyPeriod : PolicyPeriod, BillingId : String, from : Date, to : Date) : InvoiceSummaryItem[] {
    ...
    policyPeriod.Policy.Account.getPolicies().where(
