...
class ExcelImportUIHelper {
  ...
  enum importedRateTableStatus {
    NEW_RATETABLE("rate_table_import_add_16.png", DisplayKey.get("Web.Rating.Import.Add")),
    CHANGED_RATETABLE("rate_table_import_edit_16.png", DisplayKey.get("Web.Rating.Import.ChangedRateTable")),
    TOO_LARGE_RATETABLE("rate_table_import_unknown_16.png", DisplayKey.get("Web.Rating.Import.TooLarge")),
    NEW_AND_TOO_LARGE_RATETABLE("rate_table_import_unknown_16.png", DisplayKey.get("Web.Rating.Import.TooLarge")),
  ...
  property get TableCodesOfAddedTables(): List<String> {
    return _importRateTableStatus.filterByValues(\v -> v == NEW_RATETABLE).getKeys().toList()
  }

  property get TableCodesOfChangedTables(): List<String> {
    return _importRateTableStatus.filterByValues(\v -> v == CHANGED_RATETABLE).getKeys().toList()
  }

  property get TableCodesOfLargeTables(): List<String> {
    return _importRateTableStatus.filterByValues(\v -> v == TOO_LARGE_RATETABLE or v == NEW_AND_TOO_LARGE_RATETABLE).getKeys().toList()
  }
