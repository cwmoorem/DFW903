...
class RateTableParameterSetHelper extends ParameterSetHelper implements IRateTableParameterSetHelper {
  ...
  var _tableDefinition : RateTableDefinition
  ...
  function canRemoveParameter(param : RateTableColumn) : boolean {
    return not (_tableDefinition.isParamUsedInRateRoutineInPromotedRB(param) or _tableDefinition.isParameterUsedInAnyRateTable(param))
  }
  ...
  function canEditParameter(param: RateTableColumn): boolean {
    return not (_tableDefinition.UsedInPromotedRateBook or _tableDefinition.isParamUsedInAnyRateRoutine(param) or _tableDefinition.isParameterUsedInAnyRateTable(param))
  }
  ...
  function canRemoveFactor(factor: RateTableColumn): boolean {
    return not (_tableDefinition.UsedInPromotedRateBook or _tableDefinition.isFactorUsedInRateRoutineInPromotedRB(factor) or _tableDefinition.isFactorUsedInAnyRateTable(factor))
  }
  ...
  function canEditFactor(factor: RateTableColumn): boolean {
    return not (_tableDefinition.UsedInPromotedRateBook or _tableDefinition.isFactorUsedInAnyRateRoutine(factor) or _tableDefinition.isFactorUsedInAnyRateTable(factor))
  }
  ...
  function canAddFactor(): boolean {
    return not (_tableDefinition.UsedInPromotedRateBook)
  }
