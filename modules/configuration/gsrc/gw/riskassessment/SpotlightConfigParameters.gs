...
class SpotlightConfigParameters {
   ...
   */
  public static final var severityCodeToIconMap: HashMap<String, String> = {
      "High" -> "icon_risk_level_red.png",
      "Medium" -> "icon_risk_level_yellow.png",
      "Low" -> "icon_risk_level_green.png",
      "Unknown" -> "icon_risk_level_gray.png" }
