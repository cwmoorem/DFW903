...
class CalcRoutineDefinitionBuilder extends DataBuilder<CalcRoutineDefinition, CalcRoutineDefinitionBuilder> {
  ...
  function storeWithLeftParenAndConstant(storeLoc: String, constValue: String) : CalcRoutineDefinitionBuilder{
    var calcStepDefBuilder = new CalcStepDefinitionOperandBuilder()
      .withOperatorType(TC_STORE)
      .withLeftParentheses(1)
    if (constValue != null) {
  ...
  function storeWithRightParenAndConstant(storeLoc: String, constValue: String) : CalcRoutineDefinitionBuilder{
    var calcStepDefBuilder = new CalcStepDefinitionOperandBuilder()
      .withOperatorType(TC_STORE)
  ...
  function storeToCostDataField(fieldName : String, fieldType : IType, operand : CalcStepDefinitionOperandBuilder) : CalcRoutineDefinitionBuilder {
    var bldr = new CalcStepDefinitionBuilder()
          .withStepType( TC_ASSIGNMENT )
          .withInScopeLocation(CalcRoutineParamName.TC_COSTDATA, fieldName)
  ...
  function storeToCostDataFieldWithLeftParenAndConstant(fieldName : String, const : String, numLeft : int) : CalcRoutineDefinitionBuilder {
