...
class RatingQueryFacade {
   ...
   */
  @Deprecated(:value="Use getFactor(:RateBookQueryFilter, :String, : Comparable[]) instead", :version="8.0.1")
  function getFactor<Q extends Comparable, R>(filter : RateBookQueryFilter, tableCode : String, inputParam : RateQueryParam<Q>) :  RateQueryResult<R>  {
    return getFactor<Q, R>(filter, tableCode, {inputParam} as List<RateQueryParam<Q>>)
  }
