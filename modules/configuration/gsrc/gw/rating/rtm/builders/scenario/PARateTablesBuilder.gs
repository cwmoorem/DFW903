...
class PARateTablesBuilder implements RatingTestMethods {
  ...
  static function aMakeModelYearTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(
        ...
        .withOpName("YEAR")
        .withDefinition(RateTableMatchOpDefinitionBuilder.RangeMatchMaxExclOp))
  }
  ...
  static function aCoverageTermTableDefBuilder() : RateTableDefinitionBuilder {
    return new RateTableDefinitionBuilder()
      ...
      .withPolicyLine(PA_LINE)
      .addFactor(getFactor("Factor"))
      .addMatchOperation(getMatchOp(getParam(10, "CovCode", "str1")).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
      .addMatchOperation(getMatchOp(getParam(20, "CovTermCode", "str2")).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
      .addMatchOperation(getMatchOp(getParam(30, "CovTermValueCode", "str3")).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
  }
  ...
  static function aCoveragesTableDefBuilder(hasMultiSelectOptCodeColumn = false ) : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp(covParam,"Coverage", argSrcBldr1.withRoot(CalcRoutineParamName.TC_COVERAGE)).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
      .addMatchOperation(getMatchOp(covTermParam,"CovTerm", argSrcBldr2.withRoot(CalcRoutineParamName.TC_COVERAGE)).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
      .addMatchOperation(getMatchOp(covTermOptParam,"CovTermOption", argSrcBldr3.withRoot(CalcRoutineParamName.TC_COVERAGE)).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
  }
  ...
  static function aPOSTCODETableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addFactor(getFactor("Factor"))
      .addMatchOperation(getMatchOp(countryParam).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
      .addMatchOperation(getMatchOp(postCodeParam).withDefinition(RateTableMatchOpDefinitionBuilder.LongestSubstringMatchOp))
      .addMatchOperation(getMatchOp(covParam).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
  }
  ...
  static function aNumericCovTermOptTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
        ...
        .addFactor(getFactor("Factor"))
        .addMatchOperation(getMatchOp(covParam).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
        .addMatchOperation(getMatchOp(covTermParam).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
        .addMatchOperation(getMatchOp(covTermOptParam).withDefinition(RateTableMatchOpDefinitionBuilder.ExactMatchOp))
  }
}