...
class SampleDataTablesBuilder implements RatingTestMethods {
  ...
  static function aBaseRateTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    var matchopBldr3 = getMatchOp( paramBldr3, "GarageLocation.PostalCode", argSrcBldr3.withRoot(TC_VEHICLE))
        ...
        .withDefinition(LONGEST_SUBSTRING_MATCH_OP_DEF)
...
static function aSimpleTableWithPACoverageParamSet(suffix : String = "") : RateTableDefinitionBuilder {
  ...
  static function aCoveragesTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp(covParam,"Coverage", argSrcBldr1.withRoot(CalcRoutineParamName.TC_COVERAGE)).withDefinition(EXACT_MATCH_OP_DEF))
      .addMatchOperation(getMatchOp(covTermParam,"CovTerm", argSrcBldr2.withRoot(CalcRoutineParamName.TC_COVERAGE)).withDefinition(EXACT_MATCH_OP_DEF))
      .addMatchOperation(getMatchOp(covTermOptParam,"CovTermOption", argSrcBldr3.withRoot(CalcRoutineParamName.TC_COVERAGE)).withDefinition(EXACT_MATCH_OP_DEF))
      .addMatchOperation(getMatchOp(jurParam,"BaseState", argSrcBldr4).withDefinition(EXACT_MATCH_OP_DEF))
  }
  ...
  static function aVehicleAgeTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp({
        ...
        .withDefinition(RANGE_MAX_EXCL_MATCH_OP_DEF)
      )
      .addMatchOperation(getMatchOp(
...
//      .addFactor(getFactor("Factor"))
  ...
  static function aPIPNJTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp(medLimitParam, "PAPIPNJ_MEDLIMITTerm.OptionValue.OptionCode", argSrcBldr1.withRoot(CalcRoutineParamName.TC_PAPIPNJ)).withDefinition(EXACT_MATCH_OP_DEF))
      .addMatchOperation(getMatchOp(medDeductibleParam,"PAPIPNJ_MEDDEDUCTTerm.OptionValue.OptionCode", argSrcBldr2.withRoot(CalcRoutineParamName.TC_PAPIPNJ)).withDefinition(EXACT_MATCH_OP_DEF))
      .addMatchOperation(getMatchOp(medOnlyParam, "PAPIPNJ_MEDONLYTerm.Value", argSrcBldr3.withRoot(CalcRoutineParamName.TC_PAPIPNJ)).withDefinition(EXACT_MATCH_OP_DEF))
  }
  ...
  static function aPOSTCODETableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp(countryParam).withDefinition(EXACT_MATCH_OP_DEF))
      .addMatchOperation(getMatchOp(postCodeParam).withDefinition(LONGEST_SUBSTRING_MATCH_OP_DEF))
      .addMatchOperation(getMatchOp(covParam).withDefinition(EXACT_MATCH_OP_DEF))
  }
  ...
  static function aBooleanParameterTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp(boolParam).withDefinition(EXACT_MATCH_OP_DEF))
  }
  ...
  static function aDecimalParameterTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp(decimalParam).withDefinition(EXACT_MATCH_OP_DEF))
  }
  ...
  static function aDateParameterTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp(dateParam).withDefinition(EXACT_MATCH_OP_DEF))
  }
  ...
  static function aInterpolationTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
      ...
      .addMatchOperation(getMatchOp(jurParam,"BaseState",argSrcBldr1).withDefinition(EXACT_MATCH_OP_DEF))
      .addMatchOperation(getMatchOp(interpolatedParam).withDefinition(INTERPOLATED_MATCH_OP_DEF).withRateTableArgumentSource(argSrcBldr2))
      .addMatchOperation(getMatchOp(discountCodeParam).withDefinition(EXACT_MATCH_OP_DEF).withRateTableArgumentSource(argSrcBldr3))
  }
  ...
  static function aInterpolationWithRelaxTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    return new RateTableDefinitionBuilder()
        ...
        .addMatchOperation(getMatchOp(jurParam,"BaseState",argSrcBldr1).withDefinition(EXACT_MATCH_OP_DEF))
        .addMatchOperation(getMatchOp(interpolatedParam).withDefinition(INTERPOLATED_WITH_RELAX_MATCH_OP_DEF).withRateTableArgumentSource(argSrcBldr2))
        .addMatchOperation(getMatchOp(discountCodeParam).withDefinition(EXACT_MATCH_OP_DEF).withRateTableArgumentSource(argSrcBldr3))
  }
