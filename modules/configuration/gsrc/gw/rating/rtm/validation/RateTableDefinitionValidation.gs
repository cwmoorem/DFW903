...
class RateTableDefinitionValidation extends PCValidationBase {
  ...
  @Deprecated(:value="Deprecated in 8.0.2 unused", :version="8.0.2")
  ...
  function addNewArgumentSourceSetToUseParameter(){
    ...
    if (_rateTableDefinition.ArgumentSourceSets.HasElements) {
      var usedByRateRoutineInRateBook = _rateTableDefinition.IsInPromotedRateBookViaRateRoutine
      var existingParametersCovered = _rateTableDefinition.ArgumentSourceSets*.RateTableArgumentSources*.Parameter.toSet()
      if (usedByRateRoutineInRateBook and not existingParametersCovered.containsAll(_rateTableDefinition.MatchOps.toSet())){
  ...
  function parameterSetForArgSourceIsValid() {
    ...
    if (_rateTableDefinition.ArgumentSourceSets.HasElements) {
      ...
      var argSrcRoots = _rateTableDefinition.ArgumentSourceSets*.RateTableArgumentSources*.Root.toSet().where( \ elt -> elt != null)
