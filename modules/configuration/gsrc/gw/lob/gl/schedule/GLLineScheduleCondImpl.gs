  ...
  override property get PropertyInfos() : SchedulePropertyInfo[] {
   switch (typeof Owner) {
        case AmendExtRepPerdSpecAccidSchedule:
          return {
            new ScheduleDatePropertyInfo("DateCol1", DisplayKey.get("Web.Policy.GL.Schedule.Date"), true),      
            new ScheduleStringPropertyInfo("StringCol1", DisplayKey.get("Web.Policy.GL.Schedule.Location"), true),
            new ScheduleStringPropertyInfo("StringCol2", DisplayKey.get("Web.Policy.GL.Schedule.Description"), true)
          }
         ...
         case AmendExtRepPerdSpecProdWorkSchedule:
          return {
            new ScheduleTypeKeyPropertyInfo("TypeKeyCol1", DisplayKey.get("Web.Policy.GL.Schedule.Type"), (GLProductWorkType as ITypeList), null, true),
            new ScheduleStringPropertyInfo("StringCol1", DisplayKey.get("Web.Policy.GL.Schedule.Description"), true), 
            new ScheduleTypeKeyPropertyInfo("TypeKeyCol2", DisplayKey.get("Web.Policy.GL.Schedule.Act"), (GLActType as ITypeList), null, true),
            new ScheduleDatePropertyInfo("DateCol1", DisplayKey.get("Web.Policy.GL.Schedule.DateOfAct"), true)       
          }        
        default:
