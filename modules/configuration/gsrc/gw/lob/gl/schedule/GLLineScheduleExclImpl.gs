   ...
   switch (typeof Owner) {
         case ExcludeY2KCompAndElecProbSchedule:
          return {
            ...
            new ScheduleTypeKeyPropertyInfo("TypeKeyCol1", DisplayKey.get("Web.Policy.GL.Schedule.Type"), GLY2KCompSpecdCovExclType as ITypeList, null, true),
            new ScheduleBooleanPropertyInfo("BoolCol1", DisplayKey.get("Web.Policy.GL.Schedule.BodilyInjuryExcluded"), true),
            new ScheduleBooleanPropertyInfo("BoolCol2", DisplayKey.get("Web.Policy.GL.Schedule.PropertyDamageExcluded"), true)        
          }    
        default:
