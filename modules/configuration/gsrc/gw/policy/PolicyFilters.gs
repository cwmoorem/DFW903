...
class PolicyFilters {
  ...
  private class AllPolicyPeriodStatusFilter implements BeanBasedQueryFilter {
    construct() {}
  ...
  private class InForceOrScheduledStatusFilter implements BeanBasedQueryFilter {
    construct() {}
    override function applyFilter(obj: Object) : boolean {
  ...
  private class ExpiredStatusFilter implements BeanBasedQueryFilter {
    construct() {}
    override function applyFilter(obj: Object) : boolean {
      var dispStatus = (obj as PolicyPeriod).PeriodDisplayStatus
  ...
  private class CancelledStatusFilter implements BeanBasedQueryFilter {
    construct() {}
    override function applyFilter(obj: Object) : boolean {
      var dispStatus = (obj as PolicyPeriod).PeriodDisplayStatus
