...
enhancement PolicyEnhancement : Policy {
  ...
  property get PendingContingencies() : Contingency[] {
    return this.Contingencies.where( \ contingency -> contingency.Status == TC_PENDING)
  }

  property get ResolvedOrWaivedContingencies() : Contingency[] {
    return this.Contingencies.where(\contingency -> contingency.Status == TC_RESOLVED or contingency.Status == TC_WAIVED)
  }

  property get FailedContingencies() : Contingency[] {
    return this.Contingencies.where(\contingency -> contingency.Status == TC_FAILED)
  }
