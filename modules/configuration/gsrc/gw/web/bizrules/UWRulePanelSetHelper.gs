...
class UWRulePanelSetHelper {
  ...
  construct(final ruleVersion: UWRuleVersion, controller: RulePageController, location: Location) {
    _selectedRuleSupplier = \-> ruleVersion.Rule
  ...
  static property get JurisdictionRange(): List<Jurisdiction> {
    return Jurisdiction.AllTypeKeys.where(\t -> t.Categories.contains(Country.TC_US))
  }
