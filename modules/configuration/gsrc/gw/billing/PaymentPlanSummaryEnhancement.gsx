...
enhancement PaymentPlanSummaryEnhancement: entity.PaymentPlanSummary {
  ...
  property get NumberOfPayments(): int {
    return BillingUtilityMethods.getNumberOfPayments(this.DownPayment, this.Installment, this.Fee, this.Total)
  }

  /**
   * @deprecated Since PolicyCenter 8.0.2. Please use isReportingPlan instead.
   */
  @Deprecated("PC8.0.2. Deprecated, please use ReportingPlan instead.", "PC8.0.2")
