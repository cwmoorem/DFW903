...
enhancement PolicyPeriodBillingEnhancement : entity.PolicyPeriod {
   ...
   */
  @Deprecated("PC8.0.2. Please use refreshInvoiceStreams()", "PC8.0.2")
  ...
  function calculateDefaultPaymentPlan() : PaymentPlanData {
    ...
    if (priorPeriodInBC == null) {
      ...
      if (matchingPlans.length == 0) {
        ...
        var matchingReportingPlans = matchingPlans.ReportingPlans.where(\ plan -> plan.ReportingPatternCode == this.BasedOn.ReportingPattern.Code)
