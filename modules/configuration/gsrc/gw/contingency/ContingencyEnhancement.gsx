...
enhancement ContingencyEnhancement : entity.Contingency {
  ...
  property get QueryForActivities() : Activity[] {
    var act =  Query.make(Activity).select()
    return act.where(\elt -> elt.Contingency == this).toTypedArray()
  }
  ...
  /** @deprecated use {@link #queryDocuments} instead */
  @java.lang.Deprecated
  property get UpdatedDocuments() : Document[] {
    return queryDocuments(true).toTypedArray()
  }
